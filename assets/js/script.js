...
function setSlider() {
    ...
    if (active === 0) {
        container.style.backgroundImage = 'radial-gradient(circle, #FFFF00, #000000, #000000)';
        ...
        container.style.backgroundImage = 'radial-gradient(circle, #cccccc, #000000, #000000)';
        ...
        container.style.backgroundImage = 'radial-gradient(circle, 	#FF4500, #000000, #000000)';
